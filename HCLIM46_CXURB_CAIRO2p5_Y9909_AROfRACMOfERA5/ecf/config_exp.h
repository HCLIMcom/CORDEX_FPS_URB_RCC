...
# BERT: RACMO data are stored in ECFS in ec:/rus/HXMENA25/eR2v3-v578ec-Y9909-ECOCLIMAP-MAC2SP-fERA5/RACMO_HarmLBC.
EXT_ACCESS="tar xvf"                    # untar the files
EXT_BDDIR="$SCRATCH/HARMONIE/boundaries/RACMO/HXMENA25/eR2v3-v578ec-Y9909-ECOCLIMAP-MAC2SP-fERA5/RACMO_HarmLBC" # /ec/res4/scratch/rus/XRAC/HXMENA25/eR2v3-v578ec-Y9909-ECOCLIMAP-MAC2SP-fERA5/RACMO_HarmLBC/
EXT_BDFILE="RC-eR2v3-v578ec-Y9909-ECOCLIMAP-MAC2SP-fERA5_@YYYY@@MM@_d@X@.tar"
...
USEAERO=tegenaod                        # Aerosol usage: tegenaod | transientaod | camsnrt | camscms | noaero | [mocanrt]
AERO_DATA_PATH=                         # Path to aerosol data (monthly files) when USEAERO=transientaod.
