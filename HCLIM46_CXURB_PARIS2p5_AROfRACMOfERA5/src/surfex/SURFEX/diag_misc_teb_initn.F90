...
!IF (DMTO%LSURF_MISC_BUDGET) THEN
  ...
  !
  ALLOCATE(DMT%XT_CAN         (KLU))
  ALLOCATE(DMT%XQ_CAN         (KLU))
  ALLOCATE(DMT%XHU_CAN        (KLU))
  ALLOCATE(DMT%XU_CAN         (KLU))
  !
  ALLOCATE(DMT%XT_RD_CAN         (KLU))
  ALLOCATE(DMT%XT_GD_CAN         (KLU))
  ALLOCATE(DMT%XQ_RD_CAN         (KLU))
  ALLOCATE(DMT%XQ_GD_CAN         (KLU))
  !
  ALLOCATE(DMT%XTS_GARDEN         (KLU))
  !
  ALLOCATE(DMT%XTS_TOWN           (KLU))
  !
...
!
  ...
  DMT%XU_CAN        = XUNDEF
  !
  DMT%XT_RD_CAN        = XUNDEF
  DMT%XT_GD_CAN        = XUNDEF
  DMT%XQ_RD_CAN        = XUNDEF
  DMT%XQ_GD_CAN        = XUNDEF
  !
  DMT%XTS_GARDEN     = XUNDEF
  DMT%XTS_TOWN       = XUNDEF
  !
  IF (TOP%CBEM=='BEM') THEN
