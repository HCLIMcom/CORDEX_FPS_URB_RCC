...
IF (DMTO%LSURF_MISC_BUDGET) THEN
  ...
  YRECFM='TS_TOWN'
  YRECFM=ADJUSTL(YPATCH//YRECFM)
  YCOMMENT='surface temperature averaged over town'//' (K)'
  CALL WRITE_SURF(HSELECT,HPROGRAM,YRECFM,DMT%XTS_TOWN(:),IRESP,HCOMMENT=YCOMMENT)
  !
  ...
  IF (TOP%LGARDEN) THEN
    ...
    !
    ! Canyon temperature diagnostics
    YRECFM='T_RD_CAN'
    YRECFM=ADJUSTL(YPATCH//YRECFM)
    YCOMMENT='canyon temperature over road only'//' (K)'
    CALL WRITE_SURF(HSELECT,HPROGRAM,YRECFM,DMT%XT_RD_CAN(:),IRESP,HCOMMENT=YCOMMENT)
    !
    YRECFM='T_GD_CAN'
    YRECFM=ADJUSTL(YPATCH//YRECFM)
    YCOMMENT='canyon temperature over garden only'//' (K)'
    CALL WRITE_SURF(HSELECT,HPROGRAM,YRECFM,DMT%XT_GD_CAN(:),IRESP,HCOMMENT=YCOMMENT)
    !
    ! Canyon humidity diagnostics
    YRECFM='Q_RD_CAN'
    YRECFM=ADJUSTL(YPATCH//YRECFM)
    YCOMMENT='canyon specific humidity over road only'//' (kg/kg)'
    CALL WRITE_SURF(HSELECT,HPROGRAM,YRECFM,DMT%XQ_RD_CAN(:),IRESP,HCOMMENT=YCOMMENT)
    !
    YRECFM='Q_GD_CAN'
    YRECFM=ADJUSTL(YPATCH//YRECFM)
    YCOMMENT='canyon specific humidity over garden only'//' (kg/kg)'
    CALL WRITE_SURF(HSELECT,HPROGRAM,YRECFM,DMT%XQ_GD_CAN(:),IRESP,HCOMMENT=YCOMMENT)
    !
    ! Surface temperature over green areas
    YRECFM='TSGARDEN'
    YRECFM=ADJUSTL(YPATCH//YRECFM)
    YCOMMENT='surface temperature over urban green areas'//' (K)'
    CALL WRITE_SURF(HSELECT,HPROGRAM,YRECFM,DMT%XTS_GARDEN(:),IRESP,HCOMMENT=YCOMMENT)
  ENDIF
  !
  ! Mid-canyon variables
  !
  ! Canyon temperature 
  YRECFM='T_CAN'
  YRECFM=ADJUSTL(YPATCH//YRECFM)
  YCOMMENT='canyon temperature'//' (K)'
  CALL WRITE_SURF(HSELECT,HPROGRAM,YRECFM,DMT%XT_CAN(:),IRESP,HCOMMENT=YCOMMENT)
  !
  ! Canyon specific humidity 
  YRECFM='Q_CAN'
  YRECFM=ADJUSTL(YPATCH//YRECFM)
  YCOMMENT='canyon specific humidity'//' (kg/kg)'
  CALL WRITE_SURF(HSELECT,HPROGRAM,YRECFM,DMT%XQ_CAN(:),IRESP,HCOMMENT=YCOMMENT)
  !
  ! Canyon relative humidity 
  YRECFM='HU_CAN'
  YRECFM=ADJUSTL(YPATCH//YRECFM)
  YCOMMENT='canyon relative humidity'//' (-)'
  CALL WRITE_SURF(HSELECT,HPROGRAM,YRECFM,DMT%XHU_CAN(:),IRESP,HCOMMENT=YCOMMENT)
  !
  ! Canyon horizontal wind 
  YRECFM='U_CAN'
  YRECFM=ADJUSTL(YPATCH//YRECFM)
  YCOMMENT='canyon horizontal wind'//' (m/s)'
  CALL WRITE_SURF(HSELECT,HPROGRAM,YRECFM,DMT%XU_CAN(:),IRESP,HCOMMENT=YCOMMENT)
  !
  !
  !
  YRECFM='RN_BLT'
