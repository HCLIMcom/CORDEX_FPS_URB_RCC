...
!
  REAL, POINTER, DIMENSION(:)   :: XT_RD_CAN     ! canyon air temperature over road (with garden option)
  REAL, POINTER, DIMENSION(:)   :: XT_GD_CAN     ! canyon air temperature over garden (with garden option)
  REAL, POINTER, DIMENSION(:)   :: XQ_RD_CAN     ! canyon air specific humidity over road (with garden option)
  REAL, POINTER, DIMENSION(:)   :: XQ_GD_CAN     ! canyon air specific humidity over garden (with garden option)
!
  REAL, POINTER, DIMENSION(:)   :: XTS_GARDEN    ! surface temperature over green areas
!
  REAL, POINTER, DIMENSION(:)   :: XTS_TOWN      ! surface temperature over town
!
  REAL, POINTER, DIMENSION(:)   :: XT_CAN        ! canyon air temperature
  REAL, POINTER, DIMENSION(:)   :: XQ_CAN        ! canyon air specific humidity
  REAL, POINTER, DIMENSION(:)   :: XHU_CAN       ! canyon air relative humidity
  REAL, POINTER, DIMENSION(:)   :: XU_CAN        ! canyon horizontal wind
!
!------------------------------------------------------------------------------
!
...
IF (LHOOK) CALL DR_HOOK("MODD_DIAG_MISC_TEB_N:DIAG_MISC_TEB_INIT",0,ZHOOK_HANDLE)
  ...
  NULLIFY(YDIAG_MISC_TEB%XT_RD_CAN)
  NULLIFY(YDIAG_MISC_TEB%XT_GD_CAN)
  NULLIFY(YDIAG_MISC_TEB%XQ_RD_CAN)
  NULLIFY(YDIAG_MISC_TEB%XQ_GD_CAN)
  NULLIFY(YDIAG_MISC_TEB%XTS_GARDEN)
  NULLIFY(YDIAG_MISC_TEB%XTS_TOWN)
  NULLIFY(YDIAG_MISC_TEB%XT_CAN)
  NULLIFY(YDIAG_MISC_TEB%XQ_CAN)
  NULLIFY(YDIAG_MISC_TEB%XHU_CAN)
  NULLIFY(YDIAG_MISC_TEB%XU_CAN)
