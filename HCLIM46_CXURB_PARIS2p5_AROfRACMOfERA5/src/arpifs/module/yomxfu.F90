...
INTEGER(KIND=JPIM), PARAMETER :: JPFUXT=745  ! maximum number of timesteps where XFU can be activated
...
LOGICAL :: LXWFPIN                           ! activates wind farm power production XFU if .T.
...
LOGICAL :: LXMXWINDCLS                       ! activates max of U and V at 10 m if .T., same frequency as for LXXGST
