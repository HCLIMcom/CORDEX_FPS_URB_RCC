...
i=i+1
nc_tab( i ) = nctrans('TS_WATER'        ,-1,'ts_water','K','surface_temperature_over_inland_water',&
                      'Surface Temperature Over Inland Water','','')
i=i+1
...
i=i+1
nc_tab( i ) = nctrans('Q2M_TEB'         ,-1,'huss_town','1','specific_humidity_town',&
...
i=i+1
nc_tab( i ) = nctrans('T_CAN'        , -1,'tascan','K','temperature_canyon',&
                      'Mid-height temperature within canyon','','')
i=i+1
nc_tab( i ) = nctrans('T_RD_CAN'     , -1,'taspav','K','pavement_temperature',&
                      'Mid-height temperature pavements','','')
i=i+1
nc_tab( i ) = nctrans('T_GD_CAN'     , -1,'tasgree','K','greenspaces_temperature',&
                      'Mid-height temperature green spaces','','')
i=i+1
nc_tab( i ) = nctrans('Q_CAN'      , -1,'husscan','1','specific_humidity_canyon',&
                      'Mid-height Specific Humidity within canyon','','')
i=i+1
nc_tab( i ) = nctrans('Q_RD_CAN'     , -1,'husspav','1','pavement_specific_humidity',&
                      'Mid-height specific humidity pavements','','')
i=i+1
nc_tab( i ) = nctrans('Q_GD_CAN'     , -1,'hussgree','1','greenspaces_specific_humidity',&
                      'Mid-height specific humidity green spaces','','')
i=i+1
nc_tab( i ) = nctrans('HU_CAN'       , -1,'hurscan','1','relative_humidity_canyon',&
                      'Mid-height Relative Humidity within canyon','','')
i=i+1
nc_tab( i ) = nctrans('U_CAN'        , -1,'sfcWindcan','m s-1','wind_speed_canyon',&
                      'Mid-height Wind Speed within canyon','','')
