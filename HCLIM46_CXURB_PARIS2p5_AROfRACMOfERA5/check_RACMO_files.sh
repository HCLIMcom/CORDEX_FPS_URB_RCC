...
ardir=/ec/res4/scratch/nkl/HARMONIE/boundaries/RACMO/HXEUR12/eR2v3-v578ec-Y9909-LU2015-MAC2SP-fERA5/RACMO_HarmLBC
outdir=$klad/hm_home/HCLIM46_CXURB_PARIS2p5_AROfRACMOfERA5/RACMO/archive
dtg=2003010100
dtge=2010010100
...
while [ $dtg -lt $dtge ]; do
  ...
  for dec in 1 2 3; do
    ff="$ardir/RC-eR2v3-v578ec-Y9909-LU2015-MAC2SP-fERA5_${ym}_d${dec}.tar"
    printf "untar $ym $dec"
    tar xvf $ff
  done
